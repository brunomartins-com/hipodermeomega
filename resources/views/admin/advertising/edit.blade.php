            ...
            <div class="block-content">
                ...
                <div class="block-content block-content-full">
                    {!! Form::open([
                        ...
                        'url' => route('advertisingEditPut')
                        ])
                    !!}
                    {!! Form::hidden('advertisingId', $advertising->advertisingId) !!}
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                {!! Form::label('title', 'Título *') !!}
                                {!! Form::text('title', $advertising->title, ['class'=>'form-control', 'id'=>'title', 'maxlength'=>100]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                {!! Form::label('url', 'URL *') !!}
                                {!! Form::text('url', $advertising->url, ['class'=>'form-control', 'id'=>'url', 'placeholder' => 'http://', 'maxlength'=>255]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
