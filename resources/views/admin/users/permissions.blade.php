    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header bg-primary-darker text-white">
                ...
                <h3 class="block-title">Permissões - {{ $user->name }}</h3>
            </div>
                ...
                <div class="block-content block-content-full">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12 push-20-t">
                            {!! Form::submit('Save', ['class'=>'btn btn-primary pull-right push-20-l']) !!}
                            {!! Form::button('Cancel', ['class'=>'btn btn-warning pull-right', 'onclick'=>'window.open(\''.route('users').'\', \'_self\');']) !!}
                        </div>
                    </div>
                    <!-- END Intro Category -->
                    {!! Form::close() !!}
