        ...
        <div class="block">
            <div class="block-header bg-gray-lighter">
                ...
                <h3 class="block-title">
                    {!! Form::button('<i class="fa fa-plus"></i> Adicionar', ['class'=>'btn btn-primary', 'onclick'=>'window.open(\''.route('usersAdd').'\', \'_self\');']) !!}
                </h3>
            </div>
                    ...
                    @foreach($users as $user)
                        <tr>
                            ...
                            <td class="text-center">
                                {!! Form::button('<i class="fa fa-lock"></i>', ['title'=>'Permissões', 'data-toggle'=>'tooltip', 'class'=>'btn btn-xs btn-info',
                                ...
                                'data-url'=>route('usersDelete'), 'data-form'=>true, 'data-id-form'=>'textDelete'.$user->id]) !!}
                                {!! Form::close() !!}
                            </td>
                        </tr>
                    @endforeach
