                    ...
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('title', $banner->title, ['class'=>'form-control', 'id'=>'title', 'maxlength'=>45]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new" style="max-width:{{ $imageDetails['imageWidth'] }}px; max-height:{{ $imageDetails['imageHeight'] }}px;">
                                    <img src="{!! url($imageDetails['folder'].$banner->image)."?".time() !!}" alt="{{ $banner->title }}" width="80%" />
                                </div>
                                ...
                                <div class="push-20-t">
                                    <span class="btn btn-primary btn-xs btn-file">
                                        ...
                                        {!! Form::hidden('currentImage', $banner->image) !!}
